...
// Custom node-graph icon: three nodes joined by three equal-width edges
export function Diagram(svgProps: SVGProps<SVGSVGElement>) {
  return (
...
// Font Awesome 6 solid: arrow-up-right-from-square
